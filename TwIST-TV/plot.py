...
def plot_flame(ori_img, rec_img, savepath):
    ...
    plt.scatter(x, normalize_all(rec_img[point[0][0],point[0][1],:]), label='TwIST-TV', color='orange', marker='o')
    plt.ylabel('Reflectance(blue)', fontsize=15)
    plt.title('TwIST-TV flame reconstruction result', fontsize=15)
    plt.xticks([])
    plt.legend(fontsize=15,loc='upper left')
    plt.subplot(412)
    plt.plot(x, normalize_all(ori_img[point[1][0],point[1][1],:]), label='origin', color='blue', linestyle='--')
    plt.scatter(x, normalize_all(rec_img[point[1][0],point[1][1],:]), label='TwIST-TV', color='orange', marker='o')
    ...
    plt.scatter(x, normalize_all(rec_img[point[2][0],point[2][1],:]), label='TwIST-TV', color='orange', marker='o')
    ...
    plt.scatter(x, normalize_all(rec_img[point[3][0],point[3][1],:]), label='TwIST-TV', color='orange', marker='o')
...
def plot_img(ori_img, rec_img, savepath, img_name):
    ...
    plt.scatter(x, normalize_all(rec_img[point[0][0],point[0][1],:]), label='TwIST-TV', color='orange', marker='o')
    plt.ylabel('Reflectance(blue)', fontsize=15)
    plt.title('TwIST-TV image reconstruction result', fontsize=15)
    plt.xticks([])
    plt.legend(fontsize=15,loc='upper left')
    plt.subplot(412)
    plt.plot(x, normalize_all(ori_img[point[1][0],point[1][1],:]), label='origin', color='blue', linestyle='--')
